            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-zinc-500">Desenvolvido por OpenRouter</p>
                    </div>
                </div>
                <div className="flex items-center gap-2">
                    <div className="px-2 py-2 bg-zinc-800/60 border border-zinc-700/50 rounded-full text-xs text-zinc-400 backdrop-blur-sm sm:px-3 sm:py-1.5">
